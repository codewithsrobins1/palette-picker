//Main Component for the Palette Creation Form
...
class NewPaletteForm extends Component {
    ...
    handleSubmit(newPalette){
      ...
      newPalette.colors = this.state.colors;
        ...
        this.props.history.push("/"); //Be sure to have access to routeProps from app.js
    }
    ...
    //Change Color Boxes Order When Moving Around
